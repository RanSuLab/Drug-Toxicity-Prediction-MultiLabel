...
def show_confusion_matrix(Y_test, y_pred, organ, fold, lbl_num):
    ...
    axes = axes.ravel()
    label_name = ['Cellular infiltration', 'Eosinophilic change', 'Hypertrophy', 'Increased mitosis',
    ...
    font_size = {'size': '26'}  # Adjust to fit
    tick_size = 23
...
def show_tsne_lbl_figures(X_data, Y_data, organ, fold, lbl_num, str_name):
    ...
    print('Begining TSNE......')
    tsne = TSNE(n_components=2, perplexity=40, n_iter=3000, init='pca', random_state=1, verbose=1)  # Fit and transform with a TSNE
    ...
    label_name = ['Cellular infiltration', 'Eosinophilic change', 'Hypertrophy', 'Increased mitostis',
                  'NOS lesion', 'Microgranuloma', 'Necrosis', 'Hepatodiaphragmatic nodule',
                  'Kupffer cell proliferation', 'Single cell necrosis', 'Swelling', 'Cytoplasmic vacuolization']
    list_y = [0, 1]
